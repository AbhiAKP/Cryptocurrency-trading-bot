...
class Gui:
    ...
    def __init__(self, enable_gui):
        ...
        self.trading_strategies = ctb.Trading_Strategies(ticker="BTCUSDT", binance_end_point=self.binance_end_point, user=self.user, investment_amount=12, initial_balance=1000, real_trading=False)
    ...
    def create_canvas(self):
            ...
            data_frame = self.binance_end_point.get_historical_price_data("BTCUSDT", "100 minute ago UTC", self.user.get_client().KLINE_INTERVAL_1MINUTE, self.user.get_client())
